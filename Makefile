...
ICONNAME=icons/nanos_app_alkemi.gif
else ifeq ($(TARGET_NAME), TARGET_STAX)
ICONNAME=icons/stax_app_alkemi.gif
DEFINES += ICONGLYPH=C_stax_alkemi_64px
DEFINES += ICONBITMAP=C_stax_alkemi_64px_bitmap
GLYPH_FILES += $(ICONNAME)
else
ICONNAME=icons/nanox_app_alkemi.gif
endif
